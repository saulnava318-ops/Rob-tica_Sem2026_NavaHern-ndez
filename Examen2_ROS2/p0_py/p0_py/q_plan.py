...
class ScaraControl(Node):
    ...
    def cbck_scara_control(self):
        ...
        for i in range(1, 11):
            ...
            x_act = (L_1 * cos(theta_1_t) 
                + L_2 * cos(theta_1_t + theta_2_t) 
                + L_3 * cos(theta_1_t + theta_2_t + theta_3_t))
            y_act = (L_1 * sin(theta_1_t) 
                + L_2 * sin(theta_1_t + theta_2_t) 
                + L_3 * sin(theta_1_t + theta_2_t + theta_3_t))
